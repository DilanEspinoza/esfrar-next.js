        ...
        <header className=' flex justify-between lg:justify-between py-3 px-2 lg:px-7 items-center gap-5 w-full '>
            <div className=' flex w-3/5  gap-10'>
                <div className="flex items-center justify-center">
                    ...
                    <a href='/' className='text-3xl'>Esfrar</a>
                </div>
                <form
            ...
            {!isLogin ?
                <div>
                    <div className="cursor-pointer lg:hidden" onClick={handleBtnBars}><BarsIcon /></div>
                    <nav className={clickBtnBars ? "w-[50%] h-[20%]  absolute top-10 right-5 gap-6  flex justify-center items-center bg-neutral-800 z-[999] text-white py-4 rounded-2xl" : "hidden lg:flex lg:static lg:bg-none lg:top-0 "}>
                        <div className=' flex flex-col lg:flex lg:flex-row justify-center items-center gap-3 text-center  '>
                            ...
                            <Link href="/upload-image" className='py-1.5 px-5  lg:outline-1 lg:outline-black rounded-2xl lg:hover:bg-blue-600 lg:hover:outline-none lg:hover:text-white'>
                                Subir
                            </Link>
